...
namespace RKU_Canteen.User
{
    public partial class User_Register : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("insert into User_Register(FirstName,LastName,Email,PhoneNumber,Password) values ('" + txtnm.Text + "' , '" + txtlnm.Text + "' ,  '" + txteml.Text + "', '" + txtnum.Text + "'  ,'" + txtpass.Text + "' )", con);
                con.Open();
                cmd.ExecuteNonQuery();
                Clear();
            }
