<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site1.Master" AutoEventWireup="true" CodeBehind="User_Food_View.aspx.cs" Inherits="RKU_Canteen.User.User_Food_View" %>
...
<asp:Content ID="Content6" runat="server" contentplaceholderid="ContentPlaceHolder2">
        ...
        <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" CellPadding="3" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" GridLines="Both" OnItemCommand="DataList1_ItemCommand" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
            ...
            <ItemTemplate>
                ...
                <br>
                <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# Eval("Id") %>' CommandName="cmd_add" OnClick="LinkButton3_Click">Add to Cart</asp:LinkButton>
                <br>
                <br></br>
                <br></br>
                <br></br>
