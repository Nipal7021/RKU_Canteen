<%@ Page Title="" Language="C#" MasterPageFile="~/User/Site1.Master" AutoEventWireup="true" CodeBehind="View_cart.aspx.cs" Inherits="RKU_Canteen.User.View_cart" %>
     ...
     <asp:GridView runat="server" ID="gvCart" AutoGenerateColumns="False" >
         <Columns>
             ...
             <asp:TemplateField HeaderText="Product Quantity">
                 <ItemTemplate>
                     <asp:Label ID="Label3" runat="server" Text='<%# Eval("Food_Quantity") %>'></asp:Label>
                 </ItemTemplate>
             </asp:TemplateField>
         </Columns>
     </asp:GridView>
